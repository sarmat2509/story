...
| [admin-validation-analytics.spec.ts](./admin-validation-analytics.spec.ts) | Image retry/character correlation chart               | `corepack pnpm test:e2e:admin-validation-analytics` |
