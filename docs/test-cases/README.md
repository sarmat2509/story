...
| `PAID_AUDIO_USER` | Disposable-аккаунт с активной платной подпиской и историей `DRAFT_STORY_NO_AUDIO`; допустимо менять `Audio stories used this period` через admin |
...
| `PUBLIC_AUTHOR_USER` | Пользователь с псевдонимом, аватаром, блоком «О себе» и несколькими опубликованными историями |
...
| `DRAFT_STORY_NO_AUDIO` | Сгенерированная история без созданного аудио |
