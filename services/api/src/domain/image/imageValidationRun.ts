        ...
        items: {
          ...
          properties: {
            ...
            duplicateNotes: {
              type: ['string', 'null'],
              description:
                'When duplicated=true, distinguish the copy that best matches the expected staging from every extra physical copy using concrete frame location, scale, occlusion, and pose. Preferred format: "keep candidate: right foreground, hand beside ear; extra copy: smaller head and shoulders behind the radio". Null when duplicated=false.',
            },
            notes: { type: ['string', 'null'] },
          },
        },
...
function buildSegmentedSceneQaPrompt(params: {
  ...
  return [
    ...
    'When duplicated=true, duplicateNotes must identify which copy best matches the expected staging and separately localize every extra physical copy. Use concrete frame region, relation to a scene object, relative size, visible body portion/occlusion, and pose. Preferred format: "keep candidate: right foreground beside the radio, hand beside ear; extra copy: smaller head and shoulders directly behind the radio". Also mention excluded reflections/depictions when they could otherwise be confused.',
