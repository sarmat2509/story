...
## Захист від ботів і зловживань

Ми використовуємо Cloudflare Turnstile, щоб допомагати захищати WonderTales від ботів, спаму та зловживань. Turnstile може обробляти технічну інформацію, потрібну для перевірки легітимності запиту. Cloudflare обробляє цю інформацію відповідно до своєї Turnstile Privacy Policy: https://www.cloudflare.com/turnstile-privacy-policy/
