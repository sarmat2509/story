...
- Эти шесть листов не перегенерировались автоматически: изображения технически пригодны как постоянные референсы, но перед контрольными историями нужно решить, принимаем ли визуальный результат как канон или повторяем строгие счётные признаки.
