...
assert.equal(software.url, 'https://app.wondertales.com/en/');
assert.equal(software.offers.url, 'https://app.wondertales.com/en/pricing');
...
assert.match(html, /href="https:\/\/app\.wondertales\.com\/en\/pricing" class="cta-purple"/);
assert.match(html, /href="https:\/\/app\.wondertales\.com\/en\/pricing" class="cta-purple-outline"/);
