...
export const GRAPHIC_NOVEL_BUBBLE_TEXT_FONT_SIZE_PX = 14;
export const GRAPHIC_NOVEL_BUBBLE_TEXT_LINE_HEIGHT_PX = 16;
export const GRAPHIC_NOVEL_BUBBLE_TEXT_PADDING_X_PX = 10;
export const GRAPHIC_NOVEL_BUBBLE_TEXT_PADDING_Y_PX = 4;
