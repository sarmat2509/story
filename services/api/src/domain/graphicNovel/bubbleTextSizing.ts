...
export const GRAPHIC_NOVEL_BUBBLE_TEXT_FONT_SIZE_PX = 28;
export const GRAPHIC_NOVEL_BUBBLE_TEXT_LINE_HEIGHT_PX = 32;
export const GRAPHIC_NOVEL_BUBBLE_TEXT_PADDING_X_PX = 20;
export const GRAPHIC_NOVEL_BUBBLE_TEXT_PADDING_Y_PX = 8;
